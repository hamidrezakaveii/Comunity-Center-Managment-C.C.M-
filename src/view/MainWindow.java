...
public class MainWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mManagement.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/User group.gif"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Search.gif"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Search(ml, el).setVisible(true);
            }
        });

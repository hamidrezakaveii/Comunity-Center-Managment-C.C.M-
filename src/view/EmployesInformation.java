 ...
 * @author jvict
 */
public class EmployesInformation extends javax.swing.JFrame {
...
//    private MembersTableModel tableModel = new MembersTableModel();
     ...
     */
    public EmployesInformation(EmployeList el) {
        initComponents();
        this.el = el;
        ...
        for (String s : el.keySet()) {
            ...
            //Setting third column as false as if we don't do that the value of the box is going to be null
            rowData[2] = false;
    ...
    private void jbDeleteEmployesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbDeleteEmployesActionPerformed
        ...
        for (int i = 0; i < dtmTable.getRowCount(); i++) {
            ...
            if (checked != null && checked) {
                ...
                int pos = i;
                String key = (new ArrayList<String>(el.keySet())).get(pos);
                el.remove(key);
    ...
    private void jtMlMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtMlMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            int pos = target.getSelectedRow();
            String key = (new ArrayList<String>(el.keySet())).get(pos);
            java.awt.EventQueue.invokeLater(new Runnable() {
                public void run() {
                    new AddEmploye(el.get(key), el).setVisible(true);
                }
            });
        }
